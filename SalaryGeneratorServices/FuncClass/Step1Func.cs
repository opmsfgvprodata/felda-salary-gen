...
namespace SalaryGeneratorServices.FuncClass
{
    public class Step1Func
    {
        ...
        public string ResultAfterProcess()
        {
            ...
            new { estateName = b.fld_NamaLadang, regionName = b.fld_NamaWilayah, startProcess = a.fld_DTProcess, endProcess = a.fld_EndDTProcess, result = a.fld_DataToProcess }).ToList();
            string result = "";
