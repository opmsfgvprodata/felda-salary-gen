...
namespace SalaryGeneratorServices.FuncClass
{
    class Step6Func
    {
                ...
                foreach (var pkjamount in NoPkjList)
                {
                    ...
                    if (KodCaruman == GetpkjContribution)
                    {
                        ...
                        foreach (var GetOtherContributionIOs in adminSCTransM)
                        {
                            ...
                            AdminSCTransListForOtherContri.Add(new CustMod_AdminSCTrans() { fld_KodGL = GetOtherContributionIOs.fld_KodGL, fld_JumlahPkj = 0, fld_JumlahMjk = amountAfterDivM, fld_JumlahMix = 0, fld_Nopkj = pkjamount.fld_Nopkj, fld_SAPIO = GetOtherContributionIOs.fld_SAPIO, fld_KodPkt = GetOtherContributionIOs.fld_KodPkt, fld_PaySheetID = GetOtherContributionIOs.fld_PaySheetID, fld_JnisAktvt = GetOtherContributionIOs.fld_JnsAktvt });
                            //if (AvailableIO != null)
                            //{
                        ...
                        foreach (var GetOtherContributionIOs in adminSCTransP)
                        {
                            ...
                            AdminSCTransListForOtherContri.Add(new CustMod_AdminSCTrans() { fld_KodGL = GetOtherContributionIOs.fld_KodGL, fld_JumlahPkj = amountAfterDivP, fld_JumlahMjk = 0, fld_JumlahMix = 0, fld_Nopkj = pkjamount.fld_Nopkj, fld_SAPIO = GetOtherContributionIOs.fld_SAPIO, fld_KodPkt = GetOtherContributionIOs.fld_KodPkt, fld_PaySheetID = GetOtherContributionIOs.fld_PaySheetID, fld_JnisAktvt = GetOtherContributionIOs.fld_JnsAktvt });
                            //if (AvailableIO != null)
                            //{
                            //    AvailableIO.fld_KodGL = GetOtherContributionIOs.fld_KodGL;
                        ...
                        foreach (var GetOtherContributionIOs in adminSCTransMix)
                        {
                            ...
                            AdminSCTransListForOtherContri.Add(new CustMod_AdminSCTrans() { fld_KodGL = GetOtherContributionIOs.fld_KodGL, fld_JumlahPkj = 0, fld_JumlahMjk = 0, fld_JumlahMix = amountAfterDivMix, fld_Nopkj = pkjamount.fld_Nopkj, fld_SAPIO = GetOtherContributionIOs.fld_SAPIO, fld_KodPkt = GetOtherContributionIOs.fld_KodPkt, fld_PaySheetID = GetOtherContributionIOs.fld_PaySheetID, fld_JnisAktvt = GetOtherContributionIOs.fld_JnsAktvt });
                            //if (AvailableIO != null)
                            //{
                            //    AvailableIO.fld_KodGL = GetOtherContributionIOs.fld_KodGL;
        ...
        //        foreach (var pkjamount in NoPkjList)
        //        {
        //            Amount = db2.tbl_GajiBulanan.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID && x.fld_Month == Month && x.fld_Year == Year && x.fld_Nopkj == pkjamount.fld_Nopkj).Sum(s => s.fld_AIPS);
        //            Amount = Amount == null ? 0 : Amount;
        //            if (Amount != 0)
        //            {
        ...
        //                {
        //                    var AvailableIO = AdminSCTransList.Where(x => x.fld_KodGL == GetAIPSIOs.fld_KodGL && x.fld_Nopkj == pkjamount.fld_Nopkj && x.fld_SAPIO == GetAIPSIOs.fld_SAPIO && x.fld_KodPkt == GetAIPSIOs.fld_KodPkt && x.fld_PaySheetID == GetAIPSIOs.fld_PaySheetID).FirstOrDefault();
        //                    var amountAfterDiv = adminSCTrans.Where(x => x.fld_KodGL == GetAIPSIOs.fld_KodGL && x.fld_SAPIO == GetAIPSIOs.fld_SAPIO && x.fld_KodPkt == GetAIPSIOs.fld_KodPkt && x.fld_PaySheetID == GetAIPSIOs.fld_PaySheetID).Select(s => s.fld_Jumlah).FirstOrDefault();
        //                    if (AvailableIO != null)
        //                    {
        ...
        //        {
        //            var getAmount = AdminSCTransList.Where(x => x.fld_KodGL == GetAIPSIOs.fld_KodGL && x.fld_SAPIO == GetAIPSIOs.fld_SAPIO && x.fld_KodPkt == GetAIPSIOs.fld_KodPkt && x.fld_PaySheetID == GetAIPSIOs.fld_PaySheetID).Sum(s => s.fld_Jumlah);
        //            if (getAmount != 0)
        //            {
        //                AddTo_tbl_Sctran(db2, NegaraID, SyarikatID, WilayahID, LadangID, getAmount, 0, GetAIPSIOs.fld_KodPkt, AIPS.fldOptConfValue.Substring(0, 2), AIPS.fldOptConfValue, AIPS.fldOptConfFlag2, AIPS.fldOptConfDesc, DTProcess, UserID, Month, Year, "D", 9, GetAIPSIOs.fld_KodGL, GetAIPSIOs.fld_SAPIO, GetAIPSIOs.fld_SAPType, GetAIPSIOs.fld_PaySheetID);
