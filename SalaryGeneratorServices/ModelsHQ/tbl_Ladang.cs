namespace SalaryGeneratorServices.ModelsHQ
{
    ...
    public partial class tbl_Ladang
    {
        ...
        //public int? fld_KodNegeri { get; set; } // commented by kamalia 21/10/21
        [StringLength(5)]
        public string fld_KodNegeri { get; set; } // Added by kamalia 21/10/21
        ...
        [StringLength(50)] // Added by kamalia 21/10/21
        public string fld_CostCentre { get; set; } // Added by kamalia 21/10/21

        [StringLength(50)]
        public string fld_CustCPD { get; set; } // Added by kamalia 15/2/22
    }
}
